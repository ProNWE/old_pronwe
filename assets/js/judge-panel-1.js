    ...
    form.children("div").steps({
        ...
        onInit: function(event, currentIndex) {
            ...
            /*$('.score').each(function(){
                ...
                $('.btn:nth-child('+ num +')', btns).click();//addClass('active');
...
console.log('rm' + rm);
                    if (rm != -1){
                        ...
                        for (var i = 0; i < part; i++) {
                            ...
                            for (var j = 0; j < crit; j++) {
                                ...
                                //console.log(radio, "score-" + currentIndex + "-" + pos[i] +"-"+j);
                                //console.log( pos);
                                if (radio == null) {
                                    k=1;
        ...
        {
            swal({
                title: "The voting has ended",
                text: "<p>Thanks for using our service </p><br>You may view results on <a href='http://ifse.pronwe.ru/' class='pronwe_Link-small pronwe_color'>this page</a>",
                html: true,
