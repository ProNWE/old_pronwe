    ...
    form.children("div").steps({
        ...
        onFinishing: function (event, currentIndex)
        {
            ...
            for (var i = 0; i < area; i++) {
                ...
                if (score == undefined) {
                    score = 0;
                    $('input[type=radio][name="score-' + (currentIndex + 1) + '-' + pos[i] + '"]').first().attr('checked','checked');
                    $('input[type=radio][name="score-' + (currentIndex + 1) + '-' + pos[i] + '"]').first().parent().addClass('active');
                    radio.val(0);
                    $("#errorMsg").click();
                }
